...
const chromeDriverPath = path.resolve(__dirname,'../../driver/chromedriver.exe');
    ...
    it('debería subir un archivo Excel y mostrar un mensaje de éxito', async function() {
        this.timeout(60000); // Aumenta el timeout para esta prueba
        ...
        try {
            ...
            console.log('Haciendo clic en "Horarios"...');
            ...
            let filePath = path.resolve(__dirname, '../archivos_de_prueba/1_StandardReport Dixon.xlsx');
