    ...
    _nav.splice(
        ...
        items: [
          {
            ...
            to: '/vehicle/upload-excel',
          },
          {
            component: CNavItem,
            name: 'Área de vehículos',
            to: '/vehicle/vehicles',
          },
          {
            component: CNavItem,
            name: 'Área de mantenimientos',
      ...
      },
      {
        ...
        items: [
          {
            component: CNavItem,
            name: 'Subir horarios excel',
            to: '/schedule/upload-excel',
          },
          {
            component: CNavItem,
            name: 'Área de horarios',
...

      {
        ...
        items: [
          {
            component: CNavItem,
            name: 'Listado de órdenes de trabajo',
            to: '/maintenance-entry/list',
          },
        ],
      },
      {
        ...
        items: [
          {
            component: CNavItem,
            name: 'Listado de cajas de herramientas',
            to: '/toolbox/toolbox-list',
          },
        ],
      },
    )
